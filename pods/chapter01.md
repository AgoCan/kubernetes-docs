...
V1 core版本的Pod的配置模板见[Pod template](https://kubernetes.hankbook.cn/manifests/template/pod-v1-template.yaml)。
...
![Pod示意图](https://kubernetes.hankbook.cnimages/pod-overview.png)
...
![Pod Cheatsheet](https://kubernetes.hankbook.cnimages/kubernetes-pod-cheatsheet.png)
